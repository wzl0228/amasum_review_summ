...
def train_emb(args):
    ...
    for s in raw_files:
        ...
        exs = json.load(open(s, 'r', encoding='utf-8'))
...
if __name__ == "__main__":
    ...
    parser.add_argument("-mode", default='word2vec', type=str, choices=['glove', 'word2vec']) # 使用word2vec做词嵌入
    parser.add_argument("-data_path", default="json_data", type=str)
